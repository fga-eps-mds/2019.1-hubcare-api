...
LABEL_GOODFIRSTISSUE = '/issues?labels=goodfirstissue&per_page=100'
LABEL_GOOD_FIRST_ISSUE_SPACES = '/issues?labels=good%20first%20issue&page=100'
ISSUE_URL = 'https://api.github.com/search/issues?q=is:issue+state:open'
TOTAL_DAYS = 15
FIFTEEN_DAYS = 15
GOOD_FIRST_ISSUE_MAX_RATE = 0.4
HELP_WANTED_MAX_RATE = 0.4
