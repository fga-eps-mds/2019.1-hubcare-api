    ...
    def get(self, request, owner, repo, format=None):
        ...
        if(issue_serialized.data == []):
            ...
            if(github_request.status_code == 200):
                IssueTemplates.objects.create(owner=owner, repo=repo, issue_templates=True, date=date.today())
            else:
                IssueTemplates.objects.create(owner=owner, repo=repo, issue_templates=False, date=date.today())
